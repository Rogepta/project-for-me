...
interface IconTransparentLikeProps extends React.SVGProps<SVGSVGElement> {
  width?: string | number;
  height?: string | number;
}

const IconTransparentLike: React.FC<IconTransparentLikeProps> = ({
  width = 24,
  height = 24,
  ...props
}) => (
...
export default IconTransparentLike;
